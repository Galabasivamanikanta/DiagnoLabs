...
const getPgUrl = () => {
    return process.env.POSTGRES_URL || process.env.DATABASE_URL || 'postgresql://diagnolabs_user:gMAJKmXqW5hcbgvKglOj8reTTpU6kTAG@dpg-d9op1pks728c73fkb1u0-a.oregon-postgres.render.com/diagnolabs?ssl=true';
};
