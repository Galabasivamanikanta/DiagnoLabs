...
import { UserCircle, Mail, Phone, MapPin, Briefcase, Building, ShieldCheck, Edit3, Check, X, ShieldAlert, Camera } from 'lucide-react';
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(350px, 1fr) 2fr', gap: '2rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                    <div className="glass-card" style={{ padding: '2.5rem', textAlign: 'center', background: 'white' }}>
                        ...
                        <p style={{ color: 'var(--primary)', fontWeight: '700', fontSize: '1rem', marginBottom: '1.5rem' }}>System Administrator</p>
                        ...
                        <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '12px', display: 'flex', flexDirection: 'column', gap: '1rem', textAlign: 'left' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
                                ...
                                <div>
                                    ...
                                    <div style={{ fontWeight: '800', fontSize: '0.9rem' }}>Full Administration</div>
                                </div>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
                                ...
                                <div>
                                    ...
                                    <div style={{ fontWeight: '800', fontSize: '0.9rem' }}>DiagnoLabs HQ</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="glass-card" style={{ padding: '2.5rem', background: 'white' }}>
                    <h3 style={{ fontSize: '1.4rem', marginBottom: '2rem', display: 'flex', alignItems: 'center', gap: '0.75rem', borderBottom: '2px solid var(--background)', paddingBottom: '1rem' }}>
                        <UserCircle size={24} className="text-primary" /> Parameter Configuration
                    </h3>
                    ...
                    {isEditing ? (
                        <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1.5rem' }}>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="email" value={user.email} className="form-control" readOnly style={{ background: '#f1f5f9', cursor: 'not-allowed', color: 'var(--text-muted)' }} />
                                </div>
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                <label>Work/Regional Address</label>
                            ...
                            <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
                                <button type="submit" className="btn btn-primary" disabled={loading} style={{ padding: '0.8rem 2rem', borderRadius: '12px', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                                    {loading ? 'Committing...' : <><Check size={18} /> Commit Configuration</>}
                                </button>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2.5rem' }}>
                            <div>
                                <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '0.3rem' }}>Designation</div>
                                <div style={{ fontWeight: '800', fontSize: '1.1rem', color: 'var(--text-main)', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                                    <Briefcase size={18} className="text-secondary" /> Chief Portal Admin
                                </div>
                            </div>
                            <div>
                                <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '0.3rem' }}>Department</div>
                                <div style={{ fontWeight: '800', fontSize: '1.1rem', color: 'var(--text-main)', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                                    <ShieldAlert size={18} className="text-warning" /> Security & Operations
                                </div>
                            </div>
                            <div>
                                <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '0.3rem' }}>Secure Email</div>
                                <div style={{ fontWeight: '800', fontSize: '1.1rem', color: 'var(--text-main)', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                                    <Mail size={18} className="text-primary" /> {user.email}
                                </div>
                            </div>
                            <div>
                                <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '0.3rem' }}>Contact Number</div>
                                <div style={{ fontWeight: '800', fontSize: '1.1rem', color: 'var(--text-main)', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                                    <Phone size={18} className="text-success" /> {user.phone || 'Not Configured'}
                                </div>
                            </div>
                            <div style={{ gridColumn: '1 / -1' }}>
                                <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '0.3rem' }}>Regional Post</div>
                                <div style={{ fontWeight: '800', fontSize: '1.1rem', color: 'var(--text-main)', display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                                    <MapPin size={18} className="text-danger" /> {user.address?.street || 'Central Command Node, India'}
                                </div>
                            </div>
                        </div>
                    )}
